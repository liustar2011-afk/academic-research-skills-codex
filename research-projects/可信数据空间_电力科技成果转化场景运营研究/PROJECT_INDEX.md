...
- `research-system/PHASES.md`

## 阶段总览

| 阶段 | 名称 | 本项目状态 | 主要成果物 |
|---|---|---|---|
| P0 | 项目初始化 | done | 项目目录、项目说明、研究问题、研究边界、材料索引 |
| P1 | 材料诊断与框架初建 | done/current baseline | 阶段成果 v0.1、开题报告提纲、论文提纲、理论分析框架、“四化一扩散”模式 |
| P2 | 政策与文献补强 | next | 政策依据表、文献综述笔记、支线研究成果包 |
| P3 | 框架修订与开题成稿 | planned | 开题报告草稿 v0.1、修订后的提纲和模型 |
| P4 | 论文初稿写作 | planned | 论文初稿、章节草稿、图表说明 |
| P5 | 审阅与修订 | planned | 修改意见、修订记录、版本稿 |
| P6 | 定稿与输出 | planned | 定稿、汇报稿、PPT、摘要 |

## 工作机制

本项目遵循工作区通用研究项目机制：

- `research-system/README.md`
- `research-system/PHASES.md`
- `research-system/workflows/interruption-recovery-workflow.md`
- `research-system/workflows/mainline-branch-workflow.md`
- `research-system/workflows/branch-integration-checklist.md`

## 对话窗口入口

用户无需直接浏览文件系统，可通过以下文件查看项目状态：
...
- http://127.0.0.1:8010/projects/trusted-data-space-power-transfer/

## 当前基准成果

| 类型 | 文件 | 状态 |
|---|---|---|
| 阶段成果 | `02_stage_outputs/阶段成果_v0.1.md` | baseline |
| 项目说明 | `00_project_brief/项目说明.md` | draft |
| 研究问题 | `00_project_brief/研究问题.md` | draft |
| 开题提纲 | `03_outline/开题报告提纲.md` | draft |
| 论文提纲 | `03_outline/论文提纲.md` | draft |
| 理论框架 | `05_models/理论分析框架.md` | draft |
| 运营模式 | `05_models/四化一扩散运营模式.md` | draft |
| 任务板 | `TASK_BOARD.md` | draft |
| 成果物索引 | `ARTIFACTS.md` | draft |
| 过程成果物索引 | `PROCESS_ARTIFACTS.md` | active |
| 主线-支线关联矩阵 | `MAIN_BRANCH_MAP.md` | active |
| 任务-成果物关联矩阵 | `TASK_ARTIFACT_MAP.md` | active |
| 项目健康检查 | `HEALTH_CHECK.md` | active |
| 结论-证据映射表 | `CLAIM_EVIDENCE_MAP.md` | active |
| 支线汇入日志 | `INTEGRATION_LOG.md` | active |
| 问题停车场 | `QUESTION_PARKING_LOT.md` | active |
| 研究任务书 | `00_project_brief/研究任务书.md` | draft |
| 假设日志 | `HYPOTHESIS_LOG.md` | active |
| 证据目录 | `09_evidence/` | active |
| 领域适配器选择 | `10_domain_adapter/domain_selection.md` | active |
| 研究成果资产 | `06_synthesis/research_asset.md` | pending |
| Review Log | `review_log.md` | active |
| Artifact Manifest | `artifact_manifest.md` | active |

## 主线任务总表

| 编号 | 阶段 | 主线任务 | 前置/来源 | 当前状态 | 已有成果物 | 下一步 |
|---|---|---|---|---|---|---|
...
| 编号 | 所属任务 | 成果物 | 类型 | 状态 | 文件 |
|---|---|---|---|---|---|
| A-001 | M-002 | 阶段成果 v0.1 | 阶段成果 | baseline | `02_stage_outputs/阶段成果_v0.1.md` |
| A-002 | M-002 | 开题报告提纲 | 提纲 | draft | `03_outline/开题报告提纲.md` |
| A-003 | M-002 | 论文提纲 | 提纲 | draft | `03_outline/论文提纲.md` |
...
- `TASK_ARTIFACT_MAP.md`

| 任务 | 主要输入 | 主要输出 | 输出服务于 |
|---|---|---|---|
| M-002 材料诊断与框架初建 | 本地材料、用户研究方向 | 阶段成果 v0.1、提纲、理论框架、运营模式 | M-003、M-004、M-005、各支线 |
| M-003 政策依据表补强 | P1 阶段成果、B-001/B-002 支线成果 | 政策依据表 | M-005、论文第二章、论文第三章、论文第四章 |
| M-004 文献综述笔记补强 | P1 阶段成果、B-003 支线成果 | 文献综述笔记 | M-005、理论框架修订 |
| B-001 可信数据空间政策梳理 | P1 阶段成果、政策检索来源 | 支线报告、证据表、影响分析、汇入建议 | M-003，后续理论框架和论文提纲 |
| B-002 科技成果转化政策梳理 | P1 阶段成果、成果转化政策 | 支线报告、证据表、影响分析、汇入建议 | M-003、论文第二/三章，后续理论框架和运营模式 |
| B-003 行业组织与平台治理文献综述 | 项目说明、研究问题、相关文献 | 支线报告、证据表、影响分析、汇入建议 | M-004、理论框架、论文第二/五章 |

## 新引入研究系统能力

| 能力 | 状态 | 当前项目入口 |
|---|---|---|
| 事实库与证据池 | active | `09_evidence/` |
| 假设驱动研究 | active | `HYPOTHESIS_LOG.md` |
| 咨询式研究框架 | active | `00_project_brief/研究任务书.md` |
| 研究成果资产 | pending | `06_synthesis/research_asset.md` |
| 领域适配器 | active | `10_domain_adapter/domain_selection.md` |
| Word/PPT/公文交付规范 | available | `research-system/delivery/` |
| 质量闸门 | available | `research-system/quality-gates/` |
| 版本与归档 | active | `11_versions/`、`99_archive/`、`review_log.md` |
...
- 已完成项目化目录。
- 已固化阶段成果 v0.1。
- 已建立研究问题、开题报告提纲、论文提纲、理论分析框架和“四化一扩散”运营模式。
- 已建立本地材料索引和外部资料清单。
- 已补充项目管理文件，用于中断恢复、版本留存、依赖追踪和修订管理。
- 已完成 B-001“可信数据空间政策梳理”支线，并部分汇入 M-003“政策依据表补强”。
- 已完成 B-002“科技成果转化政策梳理”支线，并部分汇入 M-003“政策依据表补强”。
- 已完成 B-003“行业组织与平台治理文献综述”支线，并部分汇入 M-004“文献综述笔记补强”。
- 已建立 MkDocs 本地研究门户，用于更直观地查看项目状态、任务、成果物和证据关系。
...
```text
用户提出研究方向
→ 参考 Word/PPT/Excel 但不依赖
→ P1 材料诊断与框架初建
→ 形成阶段成果 v0.1、提纲、理论框架、“四化一扩散”模式
→ 发现政策和文献依据不足
→ 进入 P2 政策与文献补强
→ 启动 B-001 可信数据空间政策梳理
→ 形成支线成果包
...
→ 形成支线成果包
→ 部分汇入政策依据表
→ 启动 B-003 行业组织与平台治理文献综述
→ 形成支线成果包
→ 部分汇入文献综述笔记
→ 下一步汇入理论框架和论文提纲，并补电力行业政策
```
...
1. `CURRENT_STATE.md`
2. `PROJECT_INDEX.md`
3. `02_stage_outputs/阶段成果_v0.1.md`
4. 本次要修改的具体文件
...
|---|---|
| draft | 初稿，可大幅修改 |
| baseline | 当前阶段基准稿，后续修改应另起版本或记录变更 |
| review | 待检查或待确认 |
